...
public class rec_list extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*
        idan.rec_arr.add(new iReceipt(new Date(2009, 2, 12), "Sporty's", 39.99, "Electronics", false, false, "","hobot",idan.getnewplaceforsave()));
        idan.rec_arr.add(new iReceipt(new Date(2010, 8, 25), "MCdonalds", 29.99, "Food", true, true, "", "bodner",idan.getnewplaceforsave()));
        idan.rec_arr.add(new iReceipt(new Date(2010, 8, 16), "BestBuy", 129.99, "Pilot Supplies", true, true, "", "noiman",idan.getnewplaceforsave()));
        idan.rec_arr.add(new iReceipt(new Date(2010, 12, 2), "Tronics", 329.99, "Computers", true, true, "", "singer",idan.getnewplaceforsave()));
        idan.rec_arr.add(new iReceipt(new Date(2010, 12, 1), "Office Depot", 19.99, "Office Supplys",true, true, "", "cohen",idan.getnewplaceforsave()));
        idan.rec_arr.add(new iReceipt(new Date(2010, 10, 13), "El Al", 999.99, "Airliner", true, true, "", "levi",idan.getnewplaceforsave()));
        */
        ...
        adapter = new ArrayAdapter<iReceipt>(this, android.R.layout.simple_list_item_1,idan.rec_arr );
        myListView.setAdapter(adapter);
        String[] items = new String[] {"Date", "Total", "Buisness Name"};
    ...
    /*	iReceipt new_r;
    	...
    	case 10:{
    		...
    		globalR=null;
    		//need to write the new reciept to disk
    		//saveR(new_r);
    		//idan.mylistname.add(new_r.getplaceofsave());
    		//need to write mylistname to Disk
    		//();
...
/*	public void saveList(){
		  ...
		  try{
		    ObjectOutputStream outputStream = new ObjectOutputStream(openFileOutput("arrayList.tmp", Context.MODE_PRIVATE));
		    outputStream.writeObject(idan.mylistname);
		    outputStream.close();
