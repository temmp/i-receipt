...
public class compute_receipt extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// speak
		Button speakButton1 = (Button) findViewById(R.id.voice11);
		Button speakButton2 = (Button) findViewById(R.id.voice22);
		Button speakButton3 = (Button) findViewById(R.id.voice33);
	...
	class ocr_preform extends AsyncTask<Void, Void, Void> {
		...
		private boolean preform_ocr(iReceipt r) {
			...
			int ret = 0;
			try {
				if (idan.settings.getPerdormOcr())
	...
	public void onClick(View v) {
		if (v.getId() == R.id.voice11)
			startVoiceRecognitionActivity(11);
		if (v.getId() == R.id.voice22)
			startVoiceRecognitionActivity(22);
		if (v.getId() == R.id.voice33)
